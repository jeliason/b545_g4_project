...
## For LNCaP cell line
```{r}
lncap.filt <- FindTopFeatures(lncap.filt, min.cutoff = 10)
...
## For RESA cell line
```{r}
resA.filt <- FindTopFeatures(resA.filt, min.cutoff = 10)
...
## For merged 
```{r}
combined_scATAC.filt <- FindTopFeatures(combined_scATAC.filt, min.cutoff = 10)
